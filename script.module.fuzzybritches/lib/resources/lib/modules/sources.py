...
class sources:
    ...
    def sourcesFilter(self):
        ...
        if quality in ['0']: filter += [i for i in self.sources if i['quality'] == '4K' and i['source'] == 'Torrent']
        if quality in ['0']: filter += [i for i in self.sources if i['quality'] == '4K' and 'debrid' in i]
        if quality in ['0']: filter += [i for i in self.sources if i['quality'] == '4K' and not 'debrid' in i and 'memberonly' in i and i['source'] != 'Torrent']
        if quality in ['0']: filter += [i for i in self.sources if i['quality'] == '4K' and not 'debrid' in i and not 'memberonly' in i and i['source'] != 'Torrent']

        if quality in ['0', '1']: filter += [i for i in self.sources if i['quality'] == '1440p' and i['source'] == 'Torrent']
        if quality in ['0', '1']: filter += [i for i in self.sources if i['quality'] == '1440p' and 'debrid' in i]
        if quality in ['0', '1']: filter += [i for i in self.sources if i['quality'] == '1440p' and not 'debrid' in i and 'memberonly' in i and i['source'] != 'Torrent']
        if quality in ['0', '1']: filter += [i for i in self.sources if i['quality'] == '1440p' and not 'debrid' in i and not 'memberonly' in i and i['source'] != 'Torrent']

        if quality in ['0', '1', '2']: filter += [i for i in self.sources if i['quality'] == '1080p' and i['source'] == 'Official']
        if quality in ['0', '1', '2']: filter += [i for i in self.sources if i['quality'] == '1080p' and i['source'] == 'Torrent']
        if quality in ['0', '1', '2']: filter += [i for i in self.sources if i['quality'] == '1080p' and 'debrid' in i]
        if quality in ['0', '1', '2']: filter += [i for i in self.sources if i['quality'] == '1080p' and not 'debrid' in i and 'memberonly' in i and i['source'] != 'Torrent' and i['source'] != 'Official']
        if quality in ['0', '1', '2']: filter += [i for i in self.sources if i['quality'] == '1080p' and not 'debrid' in i and not 'memberonly' in i and i['source'] != 'Torrent' and i['source'] != 'Official']

        if quality in ['0', '1', '2', '3']: filter += [i for i in self.sources if i['quality'] == '720p'  and i['source'] == 'Official']
        if quality in ['0', '1', '2', '3']: filter += [i for i in self.sources if i['quality'] == '720p'  and i['source'] == 'Torrent']
        if quality in ['0', '1', '2', '3']: filter += [i for i in self.sources if i['quality'] == '720p' and 'debrid' in i]
        if quality in ['0', '1', '2', '3']: filter += [i for i in self.sources if i['quality'] == '720p' and not 'debrid' in i and 'memberonly' in i and i['source'] != 'Torrent' and i['source'] != 'Official']
        if quality in ['0', '1', '2', '3']: filter += [i for i in self.sources if i['quality'] == '720p' and not 'debrid' in i and not 'memberonly' in i and i['source'] != 'Torrent' and i['source'] != 'Official']
    ...
    def getConstants(self):
        self.itemProperty = 'plugin.video.fuzzybritches.container.items'

        self.metaProperty = 'plugin.video.fuzzybritches.container.meta'
