...
class source:
    def __init__(self):
        self.priority = 1
        self.source = ['www',, 'www0' 'www1', 'www2', 'www3', 'www4', 'www5']
        self.language = ['en']
        self.domains = ['solarmovie.to', 'solarmovie.sc', 'solarmovie.pl', 'solarmovie.cr', 'solarmovie.fun']
        self.base_link = 'http://solarmovie.to'
