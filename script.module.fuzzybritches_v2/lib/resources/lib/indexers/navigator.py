...
class navigator:
    ...
    def root(self):
        ...
        if not control.setting('lists.widget') == '0':
            self.addDirectoryItem(32329, 'mylistsNavigator', 'mythings.png', 'DefaultSets.png')
        ...
        if self.getMenuEnabled('navi.morestuff') == True:
            self.addDirectoryItem(42004, 'moreplugs', 'collections.png', 'DefaultMovies.png')
        ...
        if self.getMenuEnabled('navi.changeLog') == True:
            self.addDirectoryItem(42007,  'ShowChangelog',  'icon.gif',  'DefaultFolder.png', isFolder=False)
    ...
    def movies(self):
        ...
        if self.getMenuEnabled('navi.moviefeat') == True:
            ...
            self.addDirectoryItem(42010, 'movies2&url=featured', 'tmdb.png', 'DefaultMovies.png')
        ...
        if self.getMenuEnabled('navi.moviepopular') == True:
            self.addDirectoryItem(32018, 'movies&url=popular', 'imdb.png', 'DefaultMovies.png')
            self.addDirectoryItem(32323, 'movies&url=traktpopular', 'trakt.png', 'DefaultRecentlyAddedMovies.png')
            self.addDirectoryItem(42012, 'movies2&url=popular', 'tmdb.png', 'DefaultMovies.png')
        ...
        if self.getMenuEnabled('navi.movieboxoffice') == True:
            ...
            self.addDirectoryItem(52020, 'movies&url=traktboxoffice', 'trakt.png', 'DefaultRecentlyAddedMovies.png')
        ...
        if self.getMenuEnabled('navi.movietheaters') == True:
            ...
            self.addDirectoryItem(42016, 'movies2&url=theaters', 'tmdb.png', 'DefaultRecentlyAddedMovies.png')
    ...
    def tvshows(self):
        if self.getMenuEnabled('navi.tvGenres') == True:
            self.addDirectoryItem(52011, 'tvGenres', 'genres1.png', 'DefaultTVShows.png')
        ...
        if self.getMenuEnabled('navi.tvLanguages') == True:
            self.addDirectoryItem(52014, 'tvLanguages', 'languages1.png', 'DefaultTVShows.png')
        if self.getMenuEnabled('navi.tvCertificates') == True:
            self.addDirectoryItem(52015, 'tvCertificates', 'certificates1.png', 'DefaultTVShows.png')
        if self.getMenuEnabled('navi.tvfeat') == True:
            ...
            self.addDirectoryItem(42010, 'tvshows2&url=featured', 'tmdb.png', 'DefaultTVShows.png')
        ...
        if self.getMenuEnabled('navi.tvPopular') == True:
            self.addDirectoryItem(42012, 'tvshows2&url=popular', 'tmdb.png', 'DefaultTVShows.png')
            self.addDirectoryItem(32323, 'tvshows&url=traktpopular', 'trakt.png', 'DefaultTVShows.png')
            self.addDirectoryItem(32018, 'tvshows&url=popular', 'imdb.png', 'DefaultTVShows.png')
        if self.getMenuEnabled('navi.tvRating') == True:
            self.addDirectoryItem(42017, 'tvshows2&url=rating', 'tmdb.png', 'DefaultTVShows.png')
        ...
        if self.getMenuEnabled('navi.tvViews') == True:
            self.addDirectoryItem(42018, 'tvshows2&url=views', 'tmdb.png', 'DefaultVideoPlaylists.png')
        ...
        if self.getMenuEnabled('navi.tvshowMosts') == True:
            self.addDirectoryItem(42019, 'showMosts', 'people-watching1.png', 'DefaultTVShows.png')
        if self.getMenuEnabled('navi.tvAiring') == True:
            self.addDirectoryItem(42020, 'tvshows2&url=airing', 'tmdb.png', 'DefaultTVShows.png')
            self.addDirectoryItem(32024, 'tvshows&url=airing', 'airing-today.png', 'DefaultTVShows.png')
        if self.getMenuEnabled('navi.tvActive') == True:
            self.addDirectoryItem(42021, 'tvshows2&url=active', 'tmdb.png', 'DefaultTVShows.png')
        ...
        if self.getMenuEnabled('navi.tvPremier') == True:
            self.addDirectoryItem(42022, 'tvshows2&url=premiere', 'tmdb.png', 'DefaultVideoPlaylists.png')
        ...
        if self.getMenuEnabled('navi.tvCalendar') == True:
            self.addDirectoryItem(32027, 'calendars', 'calendar1.png', 'DefaultRecentlyAddedEpisodes.png')
        self.endDirectory()
    ...
    def tvNetworksNavigator(self):
        self.addDirectoryItem('[B][COLOR yellow]• [/COLOR][/B][COLOR ghostwhite]WebChannels[/COLOR][B][COLOR yellow] •[/COLOR][/B]', 'tvWebChannels', 'webchannels.png', 'DefaultTVShows.png')
        self.addDirectoryItem('[B][COLOR yellow]• [/COLOR][/B][COLOR ghostwhite]United States[/COLOR][B][COLOR yellow] •[/COLOR][/B]', 'tvNetworks', 'usa.png', 'DefaultTVShows.png')
        self.addDirectoryItem('[B][COLOR yellow]• [/COLOR][/B][COLOR ghostwhite]Canada[/COLOR][B][COLOR yellow] •[/COLOR][/B]', 'tvCanadanetworks', 'canada.png', 'DefaultTVShows.png')
        self.addDirectoryItem('[B][COLOR yellow]• [/COLOR][/B][COLOR ghostwhite]United Kingdom[/COLOR][B][COLOR yellow] •[/COLOR][/B]', 'tvUnitedKingdomnetworks', 'unitedkingdom.png', 'DefaultTVShows.png')
        self.addDirectoryItem('[B][COLOR yellow]• [/COLOR][/B][COLOR ghostwhite]Australia[/COLOR][B][COLOR yellow] •[/COLOR][/B]', 'tvAustralianetworks', 'australia.png', 'DefaultTVShows.png')
        self.addDirectoryItem('[B][COLOR yellow]• [/COLOR][/B][COLOR ghostwhite]Other Countries 1[/COLOR][B][COLOR yellow] •[/COLOR][/B]', 'tvOthers1networks', 'world.png', 'DefaultTVShows.png')
        self.addDirectoryItem('[B][COLOR yellow]• [/COLOR][/B][COLOR ghostwhite]Other Countries 2[/COLOR][B][COLOR yellow] •[/COLOR][/B]', 'tvOthers2networks', 'world.png', 'DefaultTVShows.png')
        self.endDirectory()
    ...
    def imdbLists(self):
        ...
        self.addDirectoryItem('LifeTime & HallMark Movies', 'hellaLifeTimeHallMark', 'imdb.png', 'DefaultVideoPlaylists.png')
        self.endDirectory()
    ...
    def moreplugs(self):
        ...
        if self.getMenuEnabled('navi.iptvChannels') == True:
            self.addDirectoryItem(42023, 'iptvNavigator', 'airing-today.png', 'DefaultTVShows.png')
        ...
        if self.getMenuEnabled('navi.docuHeaven') == True:
            self.addDirectoryItem(32631, 'docuHeaven', 'documentaries.png', 'DefaultVideoPlaylists.png')
        ...
        if self.getMenuEnabled('navi.xxx') == True:
            self.addDirectoryItem('[B][COLOR lightslategrey]• [/COLOR][/B][COLOR aqua]Adult Only[B][COLOR lightslategrey] •[/COLOR][/B] [COLOR red](XXX)[/COLOR]', 'navXXX', 'adult.png', 'DefaultTVShows.png')
        self.endDirectory()


    def iptvplug(self):
        self.addDirectoryItem('[B][COLOR magenta]• [/COLOR][/B][COLOR ghostwhite]Acronai Cable/TV/Movies[/COLOR][B][COLOR magenta] •[/COLOR][/B]',  'acronaitv_menu',  'acronaitv.png',  'DefaultTVShows.png')
        self.addDirectoryItem('[B][COLOR magenta]• [/COLOR][/B][COLOR ghostwhite]USTV Go Cable Channels[/COLOR][B][COLOR magenta] •[/COLOR][/B]', 'ustvgoNavigator', 'ustv.png', 'DefaultTVShows.png')
    ...
    def mylists(self):
        ...
        self.addDirectoryItem(52003, 'myIMDbMoviesNav', 'imdb.png', 'DefaultSets.png')
        self.addDirectoryItem(52004, 'myIMDbTvShowsNav', 'imdb.png', 'DefaultSets.png')
        self.addDirectoryItem(32541, 'libraryNavigator', 'library.png', 'DefaultAddonProgram.png')
    ...
    def library(self):
        ...
        self.addDirectoryItem(32558, 'updateLibrary&query=tool', 'library.png', 'DefaultAddonProgram.png')
    ...
    def tools(self):
        ...
        self.addDirectoryItem('[COLOR %s][B]Toggle off RealDebrid[/B][/COLOR][COLOR crimson] (red=off)[/COLOR]' % isDbird, 'ToggleDbird', 'urlresolver.png', 'DefaultAddonProgram.png', isFolder=False)
        self.addDirectoryItem('[COLOR %s][B]Toggle off AllDebrid[/B][/COLOR][COLOR crimson] (red=off)[/COLOR]' % isAdbird, 'ToggleAdbird', 'urlresolver.png', 'DefaultAddonProgram.png', isFolder=False)
        self.addDirectoryItem('[COLOR %s][B]Toggle off PremiumizeMe[/B][/COLOR][COLOR crimson] (red=off)[/COLOR]' % isPreMe, 'TogglePreMe', 'urlresolver.png', 'DefaultAddonProgram.png', isFolder=False)
        self.addDirectoryItem(32073, 'authTrakt', 'trakt.png', 'DefaultAddonProgram.png', isFolder=False)
        self.addDirectoryItem(42026,  'Pair Sites',  'tools.png',  'DefaultAddonProgram.png', isFolder=False)
        self.endDirectory()
    ...
    def search(self):
        self.addDirectoryItem(32001, 'movieSearch', 'search1.png', 'DefaultMovies.png')
        self.addDirectoryItem(32002, 'tvSearch', 'search2.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32029, 'moviePerson', 'people-search.png', 'DefaultMovies.png')
        self.addDirectoryItem(32030, 'tvPerson', 'people-search1.png', 'DefaultTVShows.png')
        self.endDirectory()
