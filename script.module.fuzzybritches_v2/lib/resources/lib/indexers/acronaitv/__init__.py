...
from resources.lib.modules import control, jsunpack
...
class acronaitv:
    def __init__(self):
        self.artbase_url = "https://github.com/ThePapaw/xml/blob/master/img/arconaitv/%s?raw=true"
    ...
    def list_categories(self):
        ...
        li = xbmcgui.ListItem("[B][COLOR firebrick]• [/COLOR][/B][COLOR ghostwhite]Live Cable TV Channels[/COLOR][B][COLOR firebrick] •[/COLOR][/B]")
        ...
        li = xbmcgui.ListItem("[B][COLOR firebrick]• [/COLOR][/B][COLOR ghostwhite]24/7 TV Shows[/COLOR][B][COLOR firebrick] •[/COLOR][/B]")
        ...
        li = xbmcgui.ListItem("[B][COLOR firebrick]• [/COLOR][/B][COLOR ghostwhite]24/7 Movies[/COLOR][B][COLOR firebrick] •[/COLOR][/B]")
